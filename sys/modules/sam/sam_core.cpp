...
extern const unsigned char freq1data_init[];
extern const unsigned char freq2data_init[];
extern const unsigned char freq3data_init[];
void ESP8266SAM::Init()
{
  int i;
  dbg_sam("init\n");
  memcpy(freq1data, freq1data_init, sizeof(freq1data));
  memcpy(freq2data, freq2data_init, sizeof(freq2data));
  memcpy(freq3data, freq3data_init, sizeof(freq3data));
...
pos48644:
  ...
  while (1)
  {
	...
	if ((index == 18) || (index == 19))                          // 'RX' & 'LX'
	{
	  ...
	  if (index < sizeof(flags) && (flags[index] & 64) != 0) {
