...
124 FOR i=16 TO 26:SPRITE i SIZE 16,16 KEY 73:NEXT 
130 maxships=5
...
340       ENDIF 
350       spy(i)=RND(202)+8
355       SPRITE 10+i PATTERN shx,shy KEY 0
360       SPRITE 10+i ON 
...
450       SPRITE 10+i PATTERN EXx,EXy KEY 156
...
1325         SPRITE 0 FLAGS 4:VSYNC 
1330         LOCATE 11,9:BG 0 OFF:PRINT "GAME OVER"
